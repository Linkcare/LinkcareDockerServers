...
### Version 8.3.30 (2026-04-26)

_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_8_3_30)_

- OS upgraded to Ubuntu Server 24.04
- Installed the PostgreSQL Driver
- PHP version upgraded to 8.3.30
- Image size reduced to 460MB

### Version 7.4.33.1 (2023-11-26)

_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_7_4_33_1_

Added support for MySQL

- Apache upgraded to 2.4.58
- Installed the OS MySQL Driver
- PHP compiled with extension pdo-mysql

### Version 7.4.33 (2023-04-19)

_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_7_4_33_
...
_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_2_5_
...
_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_2_4_

- Added PHP module "pcntl" to enable Process Control functions

### Version 2.3.0 (2020-09-23)

_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_2_3_

- Added PHP module "rewrite" to enable redirection rules in Apache (.htaccess files)

### Version 2.2.0 (2020-08-17)

_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_2_2_

- Added PHP module "mysqli" to enable access to MySQL databases

### Version 2.1.0 (2020-01-27)

_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_2_1_

- Enabled PHP module "opcache" to accelerate loading times of PHP files

### Version 2.0.0

_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_2_0_
...
_Uploaded to Docker Repository as linkcare/linkcaredockerservers:PHP_1_
...
_Uploaded to Docker Repository as linkcare/linkcaredockerservers:RoR_3_0_2_
...
_Uploaded to Docker Repository as linkcare/linkcaredockerservers:RoR_2_0_
...
_Uploaded to Docker Repository as linkcare/linkcaredockerservers:RoR_1_
